  ...
  return (
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4">
      <div className="w-full mx-auto text-center space-y-16 border border-white/10 rounded-[2rem] py-28 px-8">
        ...
        >
          <a href="https://linkedin.com/in/Shivam-Bohra" target="_blank" rel="noopener noreferrer" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-rose-600 transition duration-300 ease-out border-2 border-rose-500 rounded-full shadow-md group">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.6, delay: 0.4 }}
          className="flex items-center justify-center space-x-8"
        > <a href="https://drive.google.com/drive/folders/1x4-2LF-Y1Bx8cTmCT7pHbL7Ujz3Sz4wE?usp=sharing" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-rose-500 rounded-xl group">

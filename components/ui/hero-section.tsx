                    ...
                    <div className="space-y-8">
                        ...
                        <Reveal>
                            <p className="text-lg text-neutral-300 max-w-md leading-relaxed">
                                Software Engineer (Ex Internshala)
                            </p>
                        </Reveal>
                        ...
                        <Reveal>
                            <div className="flex items-center gap-6">
                                ...
                                <a href="https://drive.google.com/drive/folders/1x4-2LF-Y1Bx8cTmCT7pHbL7Ujz3Sz4wE?usp=sharing" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-rose-600 rounded-xl group" target="_blank">
                                ...
                                <Link
                                    href="https://github.com/WhiteMagic3333"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-rose-600 transition duration-300 ease-out border-2 border-rose-500 rounded-full shadow-md group"
                                >
